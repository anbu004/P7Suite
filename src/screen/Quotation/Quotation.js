...
export default class QuotationScreen extends Component {
    ...
    searchReadtoday(todayDate) {
        ...
        const params = {
            domain: [["state", "in", ["draft", "sent", "waiting", "approve", "decline"]], "|", ["state", "=", "draft"], ["state", "=", "sent"], ["create_date", "=", todayDate]],
    ...
    searchReadyesterday(yesterDate) {
        ...
        const params = {
            domain: [["state", "in", ["draft", "sent", "waiting", "approve", "decline"]], "|", ["state", "=", "draft"], ["state", "=", "sent"], ["create_date", "=", yesterDate]],
            fields: ["message_needaction", "name_quotation", "date_order", "partner_id", "user_id", "open_po", "exp_del_date", "amount_total", "currency_id", "state", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadthisweek(thisweekDate) {
        ...
        const params = {
            domain: [["state", "in", ["draft", "sent", "waiting", "approve", "decline"]], "|", ["state", "=", "draft"], ["state", "=", "sent"], ["create_date", ">=", thisweekDate]],
            fields: ["message_needaction", "name_quotation", "date_order", "partner_id", "user_id", "open_po", "exp_del_date", "amount_total", "currency_id", "state", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadlastweek(thisweekDate, lastweekDate) {
        ...
        const params = {
            domain: [["state", "in", ["draft", "sent", "waiting", "approve", "decline"]], "|", ["state", "=", "draft"], ["state", "=", "sent"], ["create_date", "<", thisweekDate], ["create_date", ">", lastweekDate]],
            fields: ["message_needaction", "name_quotation", "date_order", "partner_id", "user_id", "open_po", "exp_del_date", "amount_total", "currency_id", "state", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadthismonth(thismonthDate) {
        ...
        const params = {
            domain: [["state", "in", ["draft", "sent", "waiting", "approve", "decline"]], "|", ["state", "=", "draft"], ["state", "=", "sent"], ["create_date", ">=", thismonthDate]],
            fields: ["message_needaction", "name_quotation", "date_order", "partner_id", "user_id", "open_po", "exp_del_date", "amount_total", "currency_id", "state", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadlastmonth(lastmonthfirstDate, lastmonthendDate) {
        ...
        const params = {
            domain: [["state", "in", ["draft", "sent", "waiting", "approve", "decline"]], "|", ["state", "=", "draft"], ["state", "=", "sent"], ["create_date", "<", lastmonthendDate], ["create_date", ">=", lastmonthfirstDate]],
            fields: ["message_needaction", "name_quotation", "date_order", "partner_id", "user_id", "open_po", "exp_del_date", "amount_total", "currency_id", "state", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadfunction() {
        ...
        const params = {
            domain: [["state", "in", ["draft", "sent", "waiting", "approve", "decline"]], "|", ["state", "=", "draft"], ["state", "=", "sent"]],
            fields: ["message_needaction", "name_quotation", "date_order", "partner_id", "user_id", "open_po", "exp_del_date", "amount_total", "currency_id", "state", "name"],
            order: '',
            limit: '',
    ...
    goToQuotationDetailScreen(id) {
        ...
        this.props.navigation.navigate('QuotationForm', { 'opprtunityFormDetail': { opp_id: id } });
    };
    ...
    render() {
        ...
        try {
                ...
                return (
                    ...
                    <View style={styles.container}>
                        ...
                        <Header leftComponent={<FontAwesomeIcon name="long-arrow-alt-left" color='#fff' size={22}
                            ...
                            centerComponent={{ text: 'Quotation', style: { color: '#fff', fontSize: 20 } }}
            ...
            <Text style={{ fontSize: 14, textAlign: 'right', color:'green',textTransform: 'uppercase' }}>  {item.state} </Text>
                ...
                return (
                    <View style={styles.container}>
                        <Header centerComponent={{ text: 'Quotation', style: { color: '#fff', fontSize: 20 } }}
                        ...
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Text style={{ alignSelf: 'center', justifyContent: 'center', fontSize: 20, color: '#0D50B8' }}> No Quotation</Text>
