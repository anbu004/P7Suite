...
export default class InvoiceScreen extends Component {
    ...
    searchReadtoday(todayDate) {
        ...
        const params = {
            ...
            fields: ['partner_id', 'date_invoice', 'number', 'commercial_partner_id',
                'reference', 'name', 'journal_id', 'company_id', 'user_id', 'date_due', 'origin',
                'amount_total_signed', 'residual_signed', 'currency_id', 'company_currency_id',
                'state', 'type'],
            order: '',
            limit: '',
            offset: '',
    ...
    goToOprtunityDetailScreen(id) {
        console.log('key>>', id);
        this.props.navigation.navigate('InvoiceForm', { 'opprtunityFormDetail': { opp_id: id } });
    };
    ...
    SearchFilterFunction(text) {
        ...
        const newData = this.arrayholder.filter(function (item) {
            ...
            ${item.number} ${item.date_invoice} ${item.user_id[1].toUpperCase()} ${item.date_due} ${item.state.toUpperCase()}`;
                ...
                return (
                    ...
                    <View style={styles.container}>
                        ...
                        <Header leftComponent={<FontAwesomeIcon name="long-arrow-alt-left" color='#fff' size={22}
                            ...
                            centerComponent={{ text: 'Invoice', style: { color: '#fff', fontSize: 20 } }}
...
<ScrollView horizontal={true}>
                                ...
                                <View
                                    ...
                                    <View
                                        ...
                                        <View
                                            ...
                                            <Text style={{ textAlign: 'left', fontWeight: 'bold', color: 'white' }}>Invoice</Text>
                                        </View>
                                        <View
                                            style={{
                                                width: 100,
                                        ...
                                        <View
                                            ...
                                            <Text style={{ textAlign: 'left', fontWeight: 'bold', color: 'white' }}>Sales person</Text>
                                        </View>
                                    ...
                                    <Card containerStyle={{ flex: 1, borderRadius: 8 }}>
                                        ...
                                        <View
                                            ...
                                            <View
                                                ...
                                                <Text style={{ fontSize: 16, color: '#65a4ae', fontWeight: 'bold', margin: 3, flex: 1, textAlign: 'center' }}>  {item.partner_id[1]} </Text>
                                                ...
                                                <View
                                                    ...
                                                    <Text style={{ flex: 1, fontSize: 12, marginLeft: 5, textAlign: 'left' }}>Invoice: {this.from_date(item.date_invoice)}</Text>
                                                    ...
                                                    <View
                                                        ...
                                                        <Text style={{ fontSize: 12, marginLeft: 5, textAlign: 'right' }}>Due: {this.from_date(item.date_due)}</Text>
                                                ...
                                                <Text style={{ padding: 4, fontSize: 12, textAlign: 'left' }}>
                                                    <FontAwesomeIcon name="address-card" color='#000' size={12} /> Sales Person: {item.user_id[1]}</Text>

                                                <Text style={{ padding: 4, fontSize: 12, textAlign: 'left' }}>Number: {item.number}</Text>
                                                ...
                                                <View
                                                    ...
                                                    <Text style={{ flex: 1, fontSize: 12, textAlign: 'left' }}>Total: {item.amount_total_signed} <FontAwesomeIcon name="rupee-sign" size={8} /></Text>
                                                    ...
                                                    <View
                                                        ...
                                                        <Text style={{ fontSize: 12, flex: 1, textAlign: 'left' }}>Due: {item.residual_signed} <FontAwesomeIcon name="rupee-sign" size={8} /></Text>

                                                    </View>
                                                </View>

                                                <Text style={{ fontSize: 14, flex: 1, textAlign: 'right', color: 'green', fontWeight: 'bold' }}>Status: {item.state}</Text>
                ...
                return (
                    <View style={styles.container}>
                        <Header centerComponent={{ text: 'Invoice', style: { color: '#fff', fontSize: 20 } }}
                        ...
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Text style={{ alignSelf: 'center', justifyContent: 'center', fontSize: 20, color: '#0D50B8' }}> No invoice</Text>
