...
export default class VendorsFormScreen extends Component {
    constructor(props) {
        super(props)
    ...
    searchReadfunction(id) {
        ...
        const params = {
            domain: [["id", "=", id]],
            fields: ['lang', 'website', 'partner_type', 'name', 'street', 'street2', 'city', 'state_id', 'vat', 'phone', 'mobile', 'email', 'pan_no'],
            order: '',
            limit: '',
            offset: '',
        }
                        ...
                        <Card style={{ borderRadius: 20 }}>
                            ...
                            <View>
                                ...
                                <View style={{ flexDirection: 'column' }}>
                                    ...
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', textAlign: 'left', marginTop: 10 }}>{item.street} {item.street2} {item.city} {item.state_id[1]}</Text>
                                ...
                                <View style={{ flexDirection: 'column' }}>
                                    ...
                                    <Text style={{ fontSize: 14, color: 'gray', textAlign: 'left' }}>GSTIN: </Text>
                                ...
                                <View style={{ flexDirection: 'column' }}>
                                    ...
                                    <Text style={{ fontSize: 14, color: 'gray', textAlign: 'left' }}>Partner Type: </Text>
                                    <Text style={{ fontSize: 14, fontWeight: 'bold', textAlign: 'left', marginTop: 10 }}>{item.partner_type} </Text>
...
<Text style={{ fontSize: 14, flex: 4, color: 'gray', textAlign: 'left' }}>  Language: </Text>
<Text style={{ fontSize: 14, flex: 5, textAlign: 'left' }}>  English </Text>
                                ...
                                <Text style={{ fontSize: 14, flex: 4, color: 'gray', textAlign: 'left' }}>  PAN Number: </Text>
                                <Text style={{ fontSize: 14, flex: 5, textAlign: 'left' }}>  {item.pan_no} </Text>
