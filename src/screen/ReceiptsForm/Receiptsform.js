...
export default class ReceiptFormScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isLoading: true,
    ...
    searchReadfunction(id) {
        ...
        const params = {
            domain: [["id", "=", id]],
            fields: ["display_name", "partner_id", "company_id", "scheduled_date", "move_line_ids", "id", "move_ids_without_package"],
            order: '',
            limit: '',
            offset: '',
        }
            ...
            return (
                ...
                <View style={styles.container}>
                    ...
                    <Header leftComponent={<FontAwesomeIcon name="long-arrow-alt-left" color='#fff' size={22}
                        ...
                        centerComponent={{ text: 'Receipt', style: { color: '#fff', fontSize: 20 } }}
