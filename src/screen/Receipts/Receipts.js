...
export default class ReceiptsScreen extends Component {
    ...
    searchReadtoday(todayDate) {
        ...
        const params = {
            domain: [["picking_type_id", "=", 5], ["create_date", "=", todayDate]],
            fields: ['name', 'partner_id', 'scheduled_date', 'id', 'state', 'location_dest_id'],
            order: '',
            limit: '',
            offset: '',
        }
    ...
    searchReadyesterday(yesterDate) {
        ...
        const params = {
            domain: [["picking_type_id", "=", 5], ["create_date", "=", yesterDate]],
            fields: ['name', 'partner_id', 'scheduled_date', 'id', 'state', 'location_dest_id'],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadthisweek(thisweekDate) {
        ...
        const params = {
            domain: [["picking_type_id", "=", 5], ["create_date", ">=", thisweekDate]],
            fields: ['name', 'partner_id', 'scheduled_date', 'id', 'state', 'location_dest_id'],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadlastweek(thisweekDate, lastweekDate) {
        ...
        const params = {
            domain: [["picking_type_id", "=", 5], ["create_date", "<", thisweekDate], ["create_date", ">", lastweekDate]],
            fields: ['name', 'partner_id', 'scheduled_date', 'id', 'state', 'location_dest_id'],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadthismonth(thismonthDate) {
        ...
        const params = {
            domain: [["picking_type_id", "=", 5], ["create_date", ">=", thismonthDate]],
            fields: ['name', 'partner_id', 'scheduled_date', 'id', 'state', 'location_dest_id'],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadlastmonth(lastmonthfirstDate, lastmonthendDate) {
        ...
        const params = {
            domain: [["picking_type_id", "=", 5], ["create_date", "<", lastmonthendDate], ["create_date", ">=", lastmonthfirstDate]],
            fields: ['name', 'partner_id', 'scheduled_date', 'id', 'state', 'location_dest_id'],
            order: '',
            limit: '',
            offset: '',
    ...
    goToReceiptformDetailScreen(id) {
        console.log('key>>', id);
        this.props.navigation.navigate('ReceiptForm', { 'opprtunityFormDetail': { opp_id: id } });
    };
    ...
    SearchFilterFunction(text) {
        ...
        const newData = this.arrayholder.filter(function (item) {
            ...
            ${item.partner_id[1].toUpperCase()} ${item.location_dest_id[1].toUpperCase()} ${item.scheduled_date.toUpperCase()} ${item.state.toUpperCase()}`;
    ...
    render() {
        ...
        try {
            if (this.state.data.length > 0) {
                return (
                    ...
                    <View style={styles.container}>
                        ...
                        <Header leftComponent={<FontAwesomeIcon name="long-arrow-alt-left" color='#fff' size={22}
                            ...
                            centerComponent={{ text: 'Receipts', style: { color: '#fff', fontSize: 20 } }}
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                ...
                                <TouchableOpacity onPress={() => this.goToReceiptformDetailScreen(item.id)}>
                                    <Card>
                                        ...
                                        <View
                                            ...
                                            <View style={{
                                                ...
                                                <View
                                                    ...
                                                    <Text style={{ fontSize: 14, fontWeight: 'bold', flex: 3, textAlign: 'left', flexShrink: 1 }}>{item.name} </Text>
                                                    <Text style={{ fontSize: 14, fontWeight: 'bold', flexShrink: 1, textAlign: 'left' }}>{item.partner_id[1]} </Text>
                                                ...
                                                <View
                                                    ...
                                                    <Text style={{ fontSize: 14, textAlign: 'left', flex: 3, flexShrink: 1, marginTop: 5 }}>{item.location_dest_id[1]} </Text>

                                                    <Text style={{ fontSize: 14, textAlign: 'left', flexShrink: 1, marginTop: 5 }}>{this.schedule_date(item.scheduled_date)}</Text>
                ...
                return (
                    <View style={styles.container}>
                        <Header centerComponent={{ text: 'Receipts', style: { color: '#fff', fontSize: 20 } }}
                        ...
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Text style={{ alignSelf: 'center', justifyContent: 'center', fontSize: 20, color: '#0D50B8' }}> No Receipts</Text>
