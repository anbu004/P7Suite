...
export default class HRModuleSubDashboardScreen extends Component {
    constructor(props) {
        super(props)
        ...
        return (
            ...
            <View style={styles.container}>
                <Header leftComponent={<FontAwesomeIcon name="home" color='#fff' size={22}
                    ...
                    centerComponent={{ text: 'HR Module', style: { color: '#fff', fontSize: 20 } }}
...
<ImageBackground
                ...
                <View style={{ alignItems: 'center', flexDirection: 'row',marginTop:150 }}>
                    ...
                    >
                        ...
                        <TouchableOpacity onPress={() => this.onLeavePress()}>
                        ...
                        {/* <Text style={{ color: 'white' }}>Leaves</Text> */}
                        <View style={styles.rect8}>
                                <Text style={styles.text22}>Leaves</Text>
                            </View>
                    </View>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', flexDirection: 'column' }}>
                        ...
                        <TouchableOpacity onPress={() => this.onAttendancePress()}>
                        ...
                        {/* <Text style={{ color: 'white' }}>Attendances</Text> */}
                        <View style={styles.rect8}>
                                <Text style={styles.text22}>Attendances</Text>
                            </View>
                    </View>
