...
export default class EnquiryScreen extends Component {
    ...
    searchReadtoday(todayDate) {
        ...
        const params = {
            domain: ["|", ["type", "=", "lead"], ["type", "=", false], ["user_id", "=", parseInt(global.MyVar)], ["create_date", "=", todayDate]],
            fields: ["email_from", "team_id", "phone", "probability", "mobile", "stage_id", "message_needaction", "mode_enquiry_id", "is_special_product", "id", "partner_id", "probability", "create_date", "received_enquiry_date", "date_deadline", "seq_number", "name"],
            order: '',
            limit: '',
            offset: '',
        }
    ...
    searchReadyesterday(yesterDate) {
        ...
        const params = {
            domain: ["|", ["type", "=", "lead"], ["type", "=", false], ["user_id", "=", parseInt(global.MyVar)], ["create_date", "=", yesterDate]],
            fields: ["email_from", "team_id", "phone", "probability", "mobile", "stage_id", "message_needaction", "mode_enquiry_id", "is_special_product", "id", "partner_id", "probability", "create_date", "received_enquiry_date", "date_deadline", "seq_number", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadthisweek(thisweekDate) {
        ...
        const params = {
            domain: ["|", ["type", "=", "lead"], ["type", "=", false], ["user_id", "=", parseInt(global.MyVar)], ["create_date", ">=", thisweekDate]],
            fields: ["email_from", "team_id", "phone", "probability", "mobile", "stage_id", "message_needaction", "mode_enquiry_id", "is_special_product", "id", "partner_id", "probability", "create_date", "received_enquiry_date", "date_deadline", "seq_number", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadlastweek(thisweekDate, lastweekDate) {
        ...
        const params = {
            domain: ["|", ["type", "=", "lead"], ["type", "=", false], ["user_id", "=", parseInt(global.MyVar)], ["create_date", "<", thisweekDate], ["create_date", ">", lastweekDate]],
            fields: ["email_from", "team_id", "phone", "probability", "mobile", "stage_id", "message_needaction", "mode_enquiry_id", "is_special_product", "id", "partner_id", "probability", "create_date", "received_enquiry_date", "date_deadline", "seq_number", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadthismonth(thismonthDate) {
        ...
        const params = {
            domain: ["|", ["type", "=", "lead"], ["type", "=", false], ["user_id", "=", parseInt(global.MyVar)], ["create_date", ">=", thismonthDate]],
            fields: ["email_from", "team_id", "phone", "probability", "mobile", "stage_id", "message_needaction", "mode_enquiry_id", "is_special_product", "id", "partner_id", "probability", "create_date", "received_enquiry_date", "date_deadline", "seq_number", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadlastmonth(lastmonthfirstDate, lastmonthendDate) {
        ...
        const params = {
            domain: ["|", ["type", "=", "lead"], ["type", "=", false], ["user_id", "=", parseInt(global.MyVar)], ["create_date", "<", lastmonthendDate], ["create_date", ">=", lastmonthfirstDate]],
            fields: ["email_from", "team_id", "phone", "probability", "mobile", "stage_id", "message_needaction", "mode_enquiry_id", "is_special_product", "id", "partner_id", "probability", "create_date", "received_enquiry_date", "date_deadline", "seq_number", "name"],
            order: '',
            limit: '',
            offset: '',
    ...
    searchReadfunction(id) {
        ...
        const params = {
            domain: ["|", ["type", "=", "lead"], ["type", "=", false], ["user_id", "=", parseInt(id)]],
            fields: ["email_from", "team_id", "probability", "mobile", "stage_id", "message_needaction", "mode_enquiry_id", "is_special_product", "id", "partner_id", "probability", "create_date", "received_enquiry_date", "date_deadline", "seq_number", "name", "phone"],
            order: '',
            limit: '',
    ...
    goToOprtunityDetailScreen(id) {
        console.log('key>>', id);
        this.props.navigation.navigate('EnquiryForm', { 'opprtunityFormDetail': { opp_id: id } });
    };
    ...
    SearchFilterFunction(text) {
        ...
        const newData = this.arrayholder.filter(function (item) {
            ...
            ${item.phone.toUpperCase()} ${item.partner_id[1].toUpperCase()}`;
                                        ...
                                        <View
                                            ...
                                            <View style={{
                                                ...
                                                <View style={{
                                                    ...
                                                    {/* <Text style={{ fontSize: 14, textAlign: 'left', flex:1 }}> Contact by </Text> */}

                                                    {/* <Image source={require('../../assets/call.png')} style={{ alignItems: 'center',justifyContent:'center', width: 10, height: 10 }} /> */}
...
<Text style={{ fontSize: 14, textAlign: 'left' }} onPress={() => { this.dialCall(item.mobile) }}> {item.mobile} </Text>
                ...
                return (
                    <View style={styles.container}>
                        <Header centerComponent={{ text: 'Leads', style: { color: '#fff', fontSize: 20 } }}
          ...
          > */}
                        ...
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Text style={{ alignSelf: 'center', justifyContent: 'center', fontSize: 20, color: '#0D50B8' }}> No Leads</Text>
