...
export default class AttendanceScreen extends Component {
    ...
    searchReadtoday(todayDate) {
        ...
        const params = {
            ...
            fields: ['employee_id', 'check_in', 'check_out', 'id'],
            order: '',
            limit: '',
            offset: '',
        }

        return connect.searchRead('hr.attendance', params)
            .then(response => {
    ...
    SearchFilterFunction(text) {
        ...
        const newData = this.arrayholder.filter(function (item) {
            ...
            // const itemData = item.employee_id[1] ? item.employee_id[1].toUpperCase() : ''.toUpperCase();
            
            const itemData = `${item.employee_id[1].toUpperCase()} ${item.check_in} ${item.check_out}`;
    ...
    render() {
        ...
        try {
            if (this.state.data.length > 0) {
                return (
                    ...
                    <View style={styles.container}>
                        ...
                        <Header leftComponent={<FontAwesomeIcon name="long-arrow-alt-left" color='#fff' size={22}
                            ...
                            centerComponent={{ text: 'Attendance', style: { color: '#fff', fontSize: 20 } }}
                                        ...
                                        <View
                                            ...
                                            <View
                                                ...
                                                <View style={{
                                                    ...
                                                    <Text style={{ fontSize: 14, flex: 2, textAlign: 'left' }}>{item.employee_id[1]} </Text>
                                                    ...
                                                    <View
                                                        ...
                                                        <Text style={{ flex: 1, fontSize: 14, textAlign: 'left', color:'green' }}>{this.from_date(item.check_in)}</Text>

                                                        <Text style={{ flex: 1, fontSize: 14, textAlign: 'left', marginTop: 5, color:'red' }}>{this.to_date(item.check_out)}</Text>
                ...
                return (
                    <View style={styles.container}>
                        <Header centerComponent={{ text: 'Attendance', style: { color: '#fff', fontSize: 20 } }}
                        ...
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Text style={{ alignSelf: 'center', justifyContent: 'center', fontSize: 20, color: '#0D50B8' }}> No Attendance</Text>
